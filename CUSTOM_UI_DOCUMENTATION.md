...
│ │ngs   │ │  │  Output Format                                                 │ │
│ └──────┘ │  │  ┌─────────┐ ┌─────────┐ ┌─────────┐                          │ │
│          │  │  │ 📄 PDF  │ │ 📝 DOCX │ │ 📖 EPUB │  ← Format Switchers      │ │
│          │  │  └─────────┘ └─────────┘ └─────────┘                          │ │
│          │  │  📄 PDF - Universal format with professional styling          │ │
│          │  │                                                                │ │
│          │  │  ┌──────────────────────────────────────────────────────────┐ │ │
│          │  │  │            ✨ Start Forge (Glowing)                      │ │ │
│          │  │  └──────────────────────────────────────────────────────────┘ │ │
...
- Progress / Прогресс
- **Output Format / Формат вывода** (NEW)
- **📄 PDF / 📝 DOCX / 📖 EPUB** (NEW)
...
- **Output Format Selector (NEW):**
  - Three format buttons: PDF, DOCX, EPUB
  - Visual indication of selected format (accent color)
  - Format description shows below buttons
  - Buttons styled to match premium UI design
